...

{
...

  {
    ...
    case 6:
      ...
      {
        Display.gfx_CircleFilled(40, 120, 20, BLUE); //Status Anzeigen grüner Punkt (Kreis x,y,r)


        Start_Zeit_Stoppuhr[0] = millis();

        Zeit_speichern = false;
      ...
      if (digitalRead(8) == LOW)
      {
        ...
        Display.gfx_CircleFilled(40, 120, 20, GREEN); //Status Anzeigen roter Punkt (Kreis x,y,r)

        Stop_Zeit_Stoppuhr[0]=(millis())- Start_Zeit_Stoppuhr[0];
...
{
  Display.gfx_CircleFilled(100, 120, 20, BLUE);
}
